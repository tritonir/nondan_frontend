...
const ClubManagement = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(
        `https://localhost:5000/api/club/${selectedClub._id}`,
        {
          method: "PUT",
          headers: {
        ...
        <div className="flex-1 lg:ml-64 p-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              You don't have any clubs to manage. Create a new club to get
              started.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setClubSettings({ ...clubSettings, category: e.target.value })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              >
        ...
        >
          <div className="space-y-4">
            ...
            <input
              ...
              onChange={(e) =>
                setEventData({ ...eventData, image_url: e.target.value })
              }
              className="w-full px-3 py-2 border rounded-lg"
            />
