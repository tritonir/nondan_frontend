  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://nondan-backend.vercel.app/api/club/",
        {
          method: "POST",
          headers: {
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                Set up your club with all the necessary information and
                branding.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Card>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("colors.primary", e.target.value)
                        }
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("colors.secondary", e.target.value)
                        }
                        className="w-12 h-10 border border-gray-300 dark:border-gray-600 rounded cursor-pointer"
                      />
                      <input
                ...
                <div
                  ...
                  style={{ backgroundColor: clubData.colors.primary + "10" }}
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3
                        ...
                        style={{ color: clubData.colors.primary }}
                      >
