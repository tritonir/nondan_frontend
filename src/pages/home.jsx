...
import { ArrowRight, Calendar, Users, Sparkles, TrendingUp, Award, Globe } from 'lucide-react';
...
const Home = () => {
  ...
  const stats = [
    { label: 'Active Events', value: '150+', icon: Calendar, color: 'text-blue-600' },
    { label: 'Student Clubs', value: '50+', icon: Users, color: 'text-green-600' },
    { label: 'Monthly Attendees', value: '5K+', icon: TrendingUp, color: 'text-purple-600' },
    { label: 'Success Stories', value: '100+', icon: Award, color: 'text-orange-600' }
  ];
  ...
  const features = [
    {
      ...
      description: 'Find exciting events happening on campus and join activities that match your interests.',
      action: () => navigate('/explore')
    },
    {
      icon: Users,
      title: 'Join Communities',
      description: 'Connect with like-minded students through our diverse range of clubs and organizations.',
      action: () => navigate('/clubs')
    },
    {
      icon: Globe,
      title: 'Track Progress',
      description: 'Monitor your participation, earn certificates, and build your portfolio of achievements.',
      action: () => navigate(isAuthenticated ? '/student/dashboard' : '/auth/signup')
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0">
                Join thousands of students exploring opportunities, building connections, and creating unforgettable memories through campus events and clubs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              From discovering events to building communities, Nondan provides all the tools you need for an amazing campus experience.
            </p>
          </div>
